...
from tools.flow_tracker import FlowTracker
...
#            mask.hands_and_track(self, hands)
#            self.box_predict(self.flow, self.bbox)
#
...
#            print("the box went out of frame and generated this error: {}".format(e))
#            exit()
...
#
#
#    def draw_track(self, image=None):
#        if image is None:
#            image = self.image
#        if self.use_polygon:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        flow_tracker.draw_track()# poorly-named, this should be draw_track
        # draw the tracks on the hands
        for hand_track in hand_tracks:
            if hand_track.has_object_track():
                print("{} {}".format(hand_track.object_track.bbox, flow_tracker.bbox))
                flow_tracker.image = hand_track.object_track.draw_track(flow_tracker.image)
